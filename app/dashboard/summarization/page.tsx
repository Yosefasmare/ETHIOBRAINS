      ...
      >
        ...
        <div className="flex flex-col lg:flex-row gap-8 mb-8">
          ...
          <div className="lg:w-1/2">
            <div
              className={`relative border-2 border-dashed rounded-2xl p-8 transition-all duration-300 ease-in-out text-center h-[350px] 
                ${isDragging
          ...
          <div className="lg:w-1/2">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-6 h-[350px]">
